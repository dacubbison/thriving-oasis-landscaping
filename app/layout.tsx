  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta Pixel Base Code - Global for PageView on every load */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
        ...
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1128095352827346&ev=PageView&noscript=1"
          />
        </noscript>
      </head>
